    ...
    <>
      ...
      <div className="min-h-screen bg-navy-950 flex items-center justify-center text-center px-6 relative overflow-hidden">
        ...
        <div className="relative">
          <p className="font-mono text-blue-400 text-sm tracking-widest uppercase mb-4">Error 404</p>
          <h1 className="font-display font-extrabold text-8xl text-white mb-4 gradient-text">404</h1>
