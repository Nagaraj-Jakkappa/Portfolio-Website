...
export default function AdminLogin() {
  ...
  return (
    <>
      <Helmet><title>Admin Login — Nagaraj Portfolio</title></Helmet>
      ...
      <div className="min-h-screen bg-navy-950 flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="relative w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="card-base p-8 space-y-5">
            <div>
              <label className="block text-xs font-mono text-slate-400 uppercase tracking-wide mb-2">Username</label>
              <input
            ...
            <div>
              <label className="block text-xs font-mono text-slate-400 uppercase tracking-wide mb-2">Password</label>
