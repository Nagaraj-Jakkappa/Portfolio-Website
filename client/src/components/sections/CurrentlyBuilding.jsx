        ...
        <div className="flex flex-col md:flex-row gap-12 items-start">
          ...
          <div className="flex-1">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl border border-navy-700 bg-navy-800/50 hover:border-blue-500/30 transition-colors">
              ...
              <div className="p-4 rounded-xl border border-navy-700 bg-navy-800/50 hover:border-emerald-500/30 transition-colors">
                <div className="flex justify-between items-start mb-2">
          ...
          <div className="flex-1 w-full">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-5 rounded-xl border border-navy-700 bg-navy-900 flex flex-col justify-center items-center text-center">
                <span className="font-display text-4xl font-bold text-white mb-1">3+</span>
                <span className="text-xs text-slate-400 uppercase tracking-wider font-mono">Production MERN Apps</span>
              </div>
              <div className="p-5 rounded-xl border border-navy-700 bg-navy-900 flex flex-col justify-center items-center text-center">
                <span className="font-display text-4xl font-bold text-blue-400 mb-1">CMS</span>
                <span className="text-xs text-slate-400 uppercase tracking-wider font-mono">Secure Admin Panel</span>
              </div>
              <div className="p-5 rounded-xl border border-navy-700 bg-navy-900 flex flex-col justify-center items-center text-center">
                <span className="font-display text-4xl font-bold text-emerald-400 mb-1">JWT</span>
                <span className="text-xs text-slate-400 uppercase tracking-wider font-mono">Auth & Validation</span>
              </div>
              <div className="p-5 rounded-xl border border-navy-700 bg-navy-900 flex flex-col justify-center items-center text-center">
                <span className="font-display text-4xl font-bold text-purple-400 mb-1">DB</span>
