// const SKILLS = {
//   Frontend: ['React.js', 'TypeScript', 'JavaScript (ES6+)', 'Tailwind CSS', 'HTML5 / CSS3', 'React Router', 'Responsive Design'],
//   Backend: ['Node.js', 'Express.js', 'MongoDB', 'REST APIs', 'JWT Auth', 'Mongoose'],
//   'ML / AI': ['Python', 'YOLOv8', 'OpenCV', 'Flask', 'TensorFlow (basics)', 'NumPy / Pandas'],
//   Tools: ['Git & GitHub', 'VS Code', 'Postman', 'Figma', 'GitHub Pages', 'Vite'],
// };
...
//               <h3 className={`font-display font-semibold text-sm uppercase tracking-widest mb-5 px-2 py-1 rounded-md border w-fit text-xs ${LEVEL_COLORS[category]}`}>
//                 {category}
//               </h3>
...
export default function Skills() {
  ...
  // Helper function to group the flat array from MongoDB into categories
  ...
  if (loading) return null; // Section stays hidden until data is ready
  ...
  return (
    <section id="skills" className="section-padding bg-navy-950 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* If no skills are added in admin yet */}
        {skills.length === 0 && (
          <p className="text-slate-500 text-center font-mono text-sm">No skills found in database.</p>
        )}
      </div>
    </section>
  );
