...
export default function About({ content }) {
  ...
  const emailHref = social.email ? `mailto:${social.email}` : 'mailto:nagupoojary33@gmail.com';
  const linkedinUrl = social.linkedin || 'https://linkedin.com/in/nagaraj-jakkappa';
